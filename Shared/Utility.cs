...
namespace Graphics
{
    internal class Util
    {
        ...
        internal static void Gpu_scale(Texture2D src, int width, int height, FilterMode fmode)
        {
    ...
    {
        public static void AddEnumValue(Type enumType, object enumValue, string enumName)
        {
            FieldInfo enumField = enumType.GetField(enumName, BindingFlags.Public | BindingFlags.Static);
            enumField.SetValue(null, enumValue);
        }
    }
